...
/*import { apiEndpoint } from '../../../src/blog';
export { BlogHome, NotFound, Post, Preview } from '../../../src/blog/pages'
*/
//import AuthHeader from '../../../src/blog';

import { apiEndpoint } from './blog';
import { BlogHome, NotFound, Post, Preview } from './blog/pages'
...
class SwitchContainers extends React.Component {
	...
	render() {
		...
		switch (currentPage.type) {
			...
			default:
				if (locationPathname === '/blog') {
					return <BlogHome />;
				} else if (locationPathname === '/preview'){
					return <Preview />;
				}
